        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <Reveal>
            <div className="space-y-6 text-center lg:text-left">
              {/* Badge using SyncVision Teal and Green */}
              <div className="inline-block px-4 py-1.5 bg-syncvision-teal/10 border border-syncvision-teal/20 rounded-full">
                <span className="text-[var(--syncvision-green)] text-xs font-bold uppercase tracking-[0.2em]">Our Story</span>
              </div>
              
              {/* Title using SyncVision Green and Gold */}
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[var(--syncvision-green)] leading-tight">
                Foundations of <br />
                <span className="text-[var(--syncvision-green)]">Expertise & Trust</span>
              </h2>
              ...
              <div className="text-slate-600 leading-relaxed space-y-4 text-sm sm:text-base">
                ...
                <p>
                  ...
                  <span className="text-[var(--syncvision-green)] font-bold italic"> ICH-GCP</span>, national regulations, and global quality expectations.
                </p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal className="relative mt-12 lg:mt-0">
            <div className="relative mx-auto w-full max-w-[500px]">
              {/* Decorative Aura - matched to your pulse style using Teal */}
              ...
              {/* Brand Accent Decorative Elements - Aligned to Standard */}
              <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-syncvision-teal/10 rounded-full blur-3xl -z-10" />
              <div className="absolute -top-10 -left-10 w-32 h-32 bg-[var(--syncvision-gold)]/5 rounded-full blur-3xl -z-10" />
              
              {/* Innovation Badge: Updated to Green and Gold */}
              <div className="absolute -bottom-6 -right-6 bg-[var(--syncvision-green)] px-5 py-3 rounded-xl shadow-xl hidden md:flex flex-col border border-white/10">
